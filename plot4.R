plot4 <- function() {
  ...
  par(mfrow = c(2, 2))
  plot(df$mydate, df$Global_active_power, type="n", ylab="Global Active Power", xlab=""  )
  lines(df$mydate, df$Global_active_power )

  plot(df$mydate, df$Voltage, type="n", ylab="Voltage", xlab="datetime"  )
  lines(df$mydate, df$Voltage )
  ...
  plot(df$mydate, df$Global_reactive_power, type="n", ylab="Global_reactive_power", xlab="datetime"  )
  lines(df$mydate, df$Global_reactive_power )
